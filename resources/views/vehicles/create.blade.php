...
@section('title', 'مركبة جديدة - Axionyx ERP')
@section('page_title', 'إضافة مركبة جديدة')
@section('page_subtitle', 'تسجيل بيانات مركبة جديدة في الأسطول')
    ...
    <form method="POST" action="{{ route('vehicles.store') }}">
        ...
        <div class="grid grid-2" style="margin-bottom:20px;">
            <div>
                ...
                <input type="text" name="vehicle_code" value="{{ old('vehicle_code', $nextCode) }}" placeholder="مثال: VH-001" style="width:100%;background:#0b1220;border:1px solid var(--line);border-radius:10px;padding:10px 12px;color:#fff;font-size:14px;">
            ...
            <div>
                ...
                <input type="text" name="plate_number" value="{{ old('plate_number') }}" required placeholder="مثال: أ ب ج 1234" style="width:100%;background:#0b1220;border:1px solid var(--line);border-radius:10px;padding:10px 12px;color:#fff;font-size:14px;">
        ...
        <div class="grid grid-2" style="margin-bottom:20px;">
            ...
            <div>
                ...
                <input type="text" name="model" value="{{ old('model') }}" required placeholder="مثال: Toyota Hiace 2024" style="width:100%;background:#0b1220;border:1px solid var(--line);border-radius:10px;padding:10px 12px;color:#fff;font-size:14px;">
        ...
        <div class="grid grid-2" style="margin-bottom:20px;">
            <div>
                ...
                <input type="number" name="year" value="{{ old('year') }}" min="1900" max="{{ date('Y') + 1 }}" placeholder="مثال: 2024" style="width:100%;background:#0b1220;border:1px solid var(--line);border-radius:10px;padding:10px 12px;color:#fff;font-size:14px;">
            ...
            <div>
                ...
                <input type="number" name="capacity" value="{{ old('capacity') }}" min="0" step="0.01" placeholder="مثال: 1.5" style="width:100%;background:#0b1220;border:1px solid var(--line);border-radius:10px;padding:10px 12px;color:#fff;font-size:14px;">
        ...
        <div style="margin-top:24px; display:flex; gap:12px; justify-content:flex-end;">
            <a href="{{ route('vehicles.index') }}" class="btn">إلغاء</a>
            <button type="submit" class="btn primary">حفظ المركبة</button>
        </div>
    </form>
</article>
@endsection
