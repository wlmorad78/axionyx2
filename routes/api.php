...
Route::apiResource('product-companies', \App\Http\Controllers\Api\Inventory\ProductCompanyController::class);
Route::apiResource('item-prices', \App\Http\Controllers\Api\Inventory\ItemPriceController::class);
Route::post('treasuries/{id}/restore', [\App\Http\Controllers\Api\Treasury\TreasuryController::class, 'restore']);
